...
public class HotSauceRemoveFromCart extends TestBase
{
    ...
    @FindBy(xpath = "//li[@class='mini-cart-item-actions']")
    private WebElement removeFromCart;

    public HotSauceRemoveFromCart(WebDriver driver)
    {
    ...
    public HotSaucePage verifyToShowHotSauses()
    {
